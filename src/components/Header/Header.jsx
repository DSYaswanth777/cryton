...
const Header = () => (
  <Container fluid className="bg-secondary-dark">
    <div className="d-flex justify-content-between align-items-center ps-3 pe-4 py-2  text-white">
      <p className="fs-4 pt-2">Welcome to Cryptron Wallet</p>
      <div className="d-flex align-items-center justify-content-center">
        <div className="d-flex gap-3">
          <Button
            color="danger"
            outline
            className="outlineAccentBtn py-2 rounded-3"
          >
            <img src={SecurityUserIcon} alt="" className="me-1" />
            Unverified
          </Button>

          <img src={Language} alt="" className="me-1 navIcon rounded-3" />
          <img src={Notification} alt="" className="me-1  navIcon rounded-3" />
          <a href="#">
